...
public class TestFindMethodInvocationsAnalysis extends AbstractAnalysisTest {
    ...
    public void testMethodInvocationsAnalysis() {
        FindMethodInvocationsAnalysis analysis = new FindMethodInvocationsAnalysis(getMethodMatcherSet());
        List<MatchedMethodResult> matches = Arrays.asList(
            new MatchedMethodResult("baseMethod()", "org.alfasoftware.astra.core.analysis.methods.ExampleMethodAnalysis", 7)
        );
